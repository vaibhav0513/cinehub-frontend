...
export function AuthModal() {
  const { authModalOpen, closeAuthModal, activeAuthTab, openAuthModal } = useUIStore()
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,59,92,0.1)',
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, transparent, #ff3b5c80, transparent)' }}
        />
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-2 mb-7">
            ...
            <span className="font-bold text-white tracking-tight">BookMyShow</span>
          </div>
          ...
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white leading-tight">
              {activeAuthTab === 'login' ? 'Welcome back 👋' : 'Join the show 🎬'}
            </h2>
